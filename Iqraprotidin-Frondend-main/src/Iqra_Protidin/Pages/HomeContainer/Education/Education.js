...
const Education = () => {
  ...
  useEffect(() => {
    fetch("https://server.eiqraprotidin.com/educationNewsSingle")
  ...
  useEffect(() => {
    fetch("https://server.eiqraprotidin.com/educationNews")
      .then((result) => result.json())
  ...
  return (
    <Box sx={{ my: "25px" }}>
      {/* Title */}
      <Box sx={{ borderBottom: "4px solid #478FE0" }}>
        <Typography
          variant="h6"
          sx={{
            fontWeight: "bold",
            color: "#fff",
            backgroundColor: "#478FE0",
